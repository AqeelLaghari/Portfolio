...
const projects: Project[] = [
  {
    ...
    shortTitle: "JOBIFY",
    description:
      "Upload resumes and find relevant jobs using AI. Features resume analysis and recommendation systems using advanced NLP techniques.",
  ...
  },
  {
    ...
    description:
      "Personalized recommendation engine utilizing similarity algorithms to suggest movies based on given user input preferences.",
  ...
  },
  {
    ...
    description:
      "Deep learning model (DCGAN) built to generate anime-style faces from random noise, served through a custom web interface.",
  ...
  },
  {
    ...
    shortTitle: "POWER BI",
    description:
      "Interactive corporate dashboards featuring complex KPIs, DAX measures, and professional data storytelling for business insights.",
